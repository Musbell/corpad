...
def payee(money):
    ...
    # calculate tax for level 4 (35,473 - 47,059)
        ...
        tax4 = tax_for_level_1 + tax_for_level_2 + \
            tax_for_level_3 + (bal3 * 0.25)
        return tax4
    # calculate tax for level 5 (Above 47,059)
    else:
        bal4 = money - deduct_for_level_4
        tax5 = tax_for_level_1 + tax_for_level_2 + \
            tax_for_level_3 + tax_for_level_4 + (bal4 * 0.3)
        return tax5
...
total_deductions = (payee(taxable_pay)-tax_relief) + \
    nhif_deductions(taxable_pay) + nssf
