...
urlpatterns = [
    ...
    path('admin', views.adashi_admin, name='adashi-admins'),
    path('admin/dashboard', views.HomeView.as_view(), name='adashi-admin'),
    path('api', views.ChartData.as_view(), name='chart-data'),
